    ...
    const Readme = new ReadmeBuilder()
      ...
      .setFields([
        ...
        },
        {
          ...
          value: ` // JavaScript
                  - Pridebot - Your Discord bot to LGBTQ Identities | 2.9k+ servers / 263.4k+ users 
                  - PortalBot - Network/Chat bot for PortalBot network | 12 servers / 8.3k+ users
                  ...
                  - Economy Bot - Economy/Shop bot designed for Obby Street (.gg/xxs) / 4.6k+ members`,
        },
        {
          name: `Project`,
