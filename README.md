    ...
    const Readme = new ReadmeBuilder()
      ...
      .setFields([
        ...
        },
        {
          ...
          value: ` // JavaScript
                  - Pridebot - Your Discord bot to LGBTQ Identities | 7.8k+ servers / 676.2k+ users
                  - Pridebot Manager - A utility bot for Pridebot Support Server
                  - PortalBot - Network/Chat bot for PortalBot network | 35 servers / 78.5k+ users
                  - AntiForward - Discord bot designed to keep forwarded messages out of your server (Offline)
                  
                  // TypeScript
                  - Prisma Bot - Main bot for Prismatic Discord Server (.gg/friendship) / 350 members
        ...
        },
        {
          ...
          value: `// Personal Websites
                  ...
                  // Fun Websites
                  - https://youarenow.gay - Turn you and your friends gay | 1.3k+ visits / 5.9k+ "ungay" clicks
